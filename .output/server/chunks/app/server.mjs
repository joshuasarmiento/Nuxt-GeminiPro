...
import { u as useRuntimeConfig$1, $ as $fetch, w as withQuery, m as hasProtocol, p as parseURL, n as isScriptProtocol, j as joinURL, i as createError$1, o as defu, q as sanitizeStatusCode, t as createHooks } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-lMoVR2qw.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-VyeAG8zm.mjs').then((m) => m.default || m)
};
